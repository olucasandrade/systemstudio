...
interface AnimatedChallengesListProps {
  challenges: (Challenge & { solutionsCount: number })[];
}

export function AnimatedChallengesList({ challenges }: AnimatedChallengesListProps) {
  useEffect(() => {
